...
pub(crate) fn inspect_groovy_structure(content: &str) -> Result<CodeStructure, CodeStructureError> {
...
mod tests {
    ...
    #[test]
    fn inspects_groovy_items() {
        let structure = inspect_groovy_structure(
        ...
        // tree-sitter-groovy reports recovery nodes for compact snippets while
        // still surfacing the declarations needed by the outline.
    }
}
