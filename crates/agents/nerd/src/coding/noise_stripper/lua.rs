...
/// Strip comments from Lua source while preserving text shape.
pub fn strip_lua_noise(content: &str) -> String {
...
#[cfg(test)]
mod tests {
    use super::strip_lua_noise;

    #[test]
    fn strips_line_comments() {
        let input = "local x = 1 -- comment\n";
        let output = strip_lua_noise(input);
