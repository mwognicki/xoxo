//! Scala-specific noise stripping.
...
/// Strip comments from Scala source while preserving text shape.
pub fn strip_scala_noise(content: &str) -> String {
...
#[cfg(test)]
mod tests {
    use super::strip_scala_noise;

    #[test]
    fn strips_line_comments() {
        let input = "val x = 1 // comment\n";
        let output = strip_scala_noise(input);
