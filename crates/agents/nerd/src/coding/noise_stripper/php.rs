...
#[cfg(test)]
mod tests {
    use super::strip_php_noise;

    #[test]
    fn strips_double_slash_line_comments() {
        let input = "<?php\n$value = 1; // comment\n";
        let output = strip_php_noise(input);
