//! Julia-specific noise stripping.
...
/// Strip comments from Julia source while preserving text shape.
pub fn strip_julia_noise(content: &str) -> String {
...
#[cfg(test)]
mod tests {
    use super::strip_julia_noise;

    #[test]
    fn strips_line_comments() {
        let input = "x = 1 # comment\n";
        let output = strip_julia_noise(input);
